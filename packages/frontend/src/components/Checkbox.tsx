...
export function Checkbox({ checked, onChange, className = "" }: CheckboxProps) {
    return (
        ...
        >
            ...
            <div className="w-5 h-5 rounded border-2 border-kiwi-dark-grey bg-transparent transition-all peer-checked:bg-kiwi-dark-grey peer-checked:border-kiwi-dark-grey flex items-center justify-center">
                {checked && <CheckIcon />}
            </div>
        </label>
    );
